...
public class Colours {
    ...
    public static String getColoursName() {
        ...
        System.out.println("Try to type only the first letter of your favourite colour. Then wait adn see wat`s gonna happen. Interested? OK let`s go. Please type a letter");
